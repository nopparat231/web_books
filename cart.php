            ...
            <div class="d-flex justify-content-center row">
                <div class="col-md-8">
                    ...
                    <div class="d-flex flex-row justify-content-between align-items-center p-2 bg-white mt-4 px-3 rounded">
                        ...
                        <div>
                            <h5 class="text-grey">ฺ20.00 บาท</h5>
                        </div>
                    ...
                    <div style="margin-left: 30rem;padding-top: 1rem;">
                        <span><b><h3> รวม 80 บาท</h3></b></span>
                    </div>
                    <div class="d-flex flex-row align-items-center mt-3 p-2 bg-white rounded"><button class="btn btn-warning btn-block btn-lg ml-2 pay-button" type="button">ยืนยันการสั่งซื้อ</button></div>
                </div>
            </div>
        </div>
    </form>
