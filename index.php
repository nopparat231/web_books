...
<head>
    ...
    <link href="<?php echo require __DIR__?>/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div class="sidebar-brand-text mx-3">Books</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php">
                    ...
                    <span>รายการสินค้าทั้งหมด</span></a>
            </li>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded" src="https://source.unsplash.com/Mv9hjnEUHR4/60x60" alt="...">
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="?cart">Read More Messages</a>
                            </div>
                        </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Books 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
